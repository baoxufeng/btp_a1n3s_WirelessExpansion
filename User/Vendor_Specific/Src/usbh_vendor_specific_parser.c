...
/** @defgroup USBH_VS_PARSER
  * @brief    This file includes VS parsers for USB Host VS class.
  * @{
  */

/** @defgroup USBH_VS_PARSER_Private_TypesDefinitions
  * @{
  */
/**
  * @}
...
/** @defgroup USBH_VS_PARSER_Private_Defines
  * @{
  */
/**
  * @}
...
/** @defgroup USBH_VS_PARSER_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup USBH_VS_PARSER_Private_FunctionPrototypes
  * @{
  */
...
/** @defgroup USBH_VS_PARSER_Private_Variables
  * @{
  */
...
/** @defgroup USBH_VS_PARSER_Private_Functions
  * @{
  */
